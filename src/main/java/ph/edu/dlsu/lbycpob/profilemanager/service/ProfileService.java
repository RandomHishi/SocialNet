...
public class ProfileService {
    ...
    public ProfileService(ProfileRepository profileRepository, FriendRepository
                                  friendRepository, ImageCompressionService imageCompressionService,
    ...
    public List<Profile> getFriendsOf(UUID profileId) {
        ...
        return friendIds.isEmpty() ? List.of() :
                profileRepository.findAllById(friendIds);
    }
    ...
    public String updatePictureFromUpload(UUID id, MultipartFile file) {
        ...
        String publicUrl = supabaseStorageService.uploadAndGetPublicUrl(path, webp,
                "image/webp");
